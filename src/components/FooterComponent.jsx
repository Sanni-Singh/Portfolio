...
const FooterComponent = ()=>{
    ...
    return(
        <motion.section style={{
            ...
            <div className="text-white  w-screen bg-transparent flex justify-between items-center sm:px-10 py-5">
                <div>
                    <h3 className="sm:text-xl text-md flex gap-2">Bihar,<span>India</span></h3>
                    <p>{tarik}</p>
                </div>
                <p className="flex justify-center text-center items-center gap-3 sm:text-xl text-md">Made With 💓 by Sanni</p>
                <a href="#Home">
                <motion.button style={{border,borderShadow}} className=" bg-gray-950/10 text-gray-50 transition-colours p-2 rounded-lg cursor-pointer hover:bg-gray-950/50 sm:text-xl text-[10px]">Back To Top</motion.button>
                </a>
            </div>
