...
const Skills = () => {
  return (
    ...
    <Header title="SKILLS"/>
      ...
      <div className="text-white text-2xl font-bold flex flex-wrap gap-8   max-w-[900px] mx-auto justify-center items-center  md:px-4 pt-8 md:pt-10 lg:pt-16 xl:pt-20">
